...
/***********************************************
 * read_cards: Reads the cards into the        *
 *             external variables num_in_rank  *
 *             and num_in_suit;                *
...
/***********************************************
 * analyze_hand: Determines whether the hand   *
 *               contains a straighrt, flush   *
 *               four-of-a-kind; determines the*
 *               number of pairs; stores the   *
 *               results into the external     *
